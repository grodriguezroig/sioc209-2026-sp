...
3. (Optional) Edit the books source files located in the `sioc209-2026-sp/` directory
4. Run `jupyter-book clean sioc209-2026-sp/` to remove any existing builds
5. Run `jupyter-book build sioc209-2026-sp/`

A fully-rendered HTML version of the book will be built in `sioc209-2026-sp/_build/html/`.
